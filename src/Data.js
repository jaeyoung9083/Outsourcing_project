...
export const qnaList = [
	{
		"q": "죽으면 바라는 것은?",
		"a": [
			{ "answer": "여러 세대에 걸쳐 가족을 부양할 수 있을 만큼 부유해지기를 바랍니다.", "type": 1 },
			{ "answer": "성공을 거두고 세계를 여행했다.", "type": 1 },
			{ "answer": "평생 친구들에게 둘러싸여 있다.", "type": 3 },
			{ "answer": "알아야 할 모든 것을 배웠다.", "type": 1 }
		]
	},
	{
		"q": "한 무리의 불량배들이 범생이를 괴롭히는 것을 보았습니다. 당신은...",
		"a": [
			{ "answer": "불량배들에게 다가가서 소리를 지릅니다.", "type": 1 },
			{ "answer": "나중에 범생이를 찾아서 그에게 다가갑니다.", "type": 2 },
			{ "answer": "범생이에게 동정심을 느끼되 그냥 지나칩니다.", "type": 2 },
			{ "answer": "조금 재미있다고 생각합니다.", "type": 3 }
		]
	},
	{
		"q": "이 중 어떤 것이 당신의 삶을 가장 향상시킬까요?",
		"a": [
			{ "answer": "더 많은 돈 절약", "type": 3 },
			{ "answer": "새로운 기술 배우기", "type": 2 },
			{ "answer": "온라인에서 자신을 보호", "type": 4 },
			{ "answer": "여행 가기", "type": 1 },
			{ "answer": "새로운 언어 배우기.", "type": 2 },
			{ "answer": "HBO 시청하기.", "type": 2 }
		]
	},
	{
		"q": "다음 중 어떤 엔터테인먼트 직업이 가장 매력적으로 느껴지나요?",
		"a": [
			{ "answer": "에이전트", "type": 1 },
			{ "answer": "시나리오 작가.", "type": 2 },
			{ "answer": "주요 영화 배우.", "type": 2 },
			{ "answer": "엔터테인먼트 변호사.", "type": 3 }
		]
	},
	{
		"q": "좋아하는 사람을 어떻게 꼬시나요?",
		"a": [
			{ "answer": "안 합니다. 마음에 들면 솔직하게 말합니다.", "type": 1 },
			{ "answer": "진솔하고 깊은 대화를 시도합니다.", "type": 2 },
			{ "answer": "재치 있는 농담을 하고 수줍은 미소를 지으며 상대의 마음을 사로잡습니다.", "type": 2 },
			{ "answer": "상대방에게 멋지고 치기 어린 픽업이나 윙크를 합니다.", "type": 2 }
		]
	}
...
/*
q) when you die, you hope to...
1) Be wealthy enough to provide for many generations of your family.
2) Have achieved success and traveled the world.
3) Be surrounded by lifelong friends.
4) Have learned everything there is to know.

q) You see a group of bullies picking on a nerd. You...
1) Go up to the bullies and yell in their faces.
2) Find the nerd afterwards and reach out to him.
3) Sympathize with the nerd but walk on by.
4) Think it's a little funny.

q) which of these would most improve your life?
1) Saving more money
...
q) Which of these entertainment professions most appeals to you?
1) Agent
2) Screenwriter.
3) Major movie star.
4) Entertainment lawyer.

q) How do you flirt with someone you like?
1) You don't; you'll tell someone straight-up if you like them.
2) Try to have a real, deep conversation.
3) You make witty jokes and smile coyly to charm the pants off them.
4) You deliver a great, cheesy pick-up or wink at them.

q) In high school, your favorite extracurricular was...
1) Student government.
2) A sports team.
3) A student club.
4) A debate or academic team.

q) You get home from the corner store and notice you were a little undercharged. You...
1) Drive back to the store and pay the difference.
2) Don't worry about it; it's only a few dollars off.
3) Will tell them next time you shop there... if you ever go back.
4) Can't believe your luck.

q) Your idea of a worthwhile summer vacation is...
1) Hanging out and catching up with friends back home.
2) Parachuting or diving off the cliffs of Acapulco.
3) Curling up with a good book on the porch.
4) Summer school.

q) How do you get your time alone when you want it?
1) Tell your friends it's reflection time and retreat to your room.
2) Cancel on a movie date with friends.
3) Disappear for long periods without a world.
4) Do errands or go for a drive.

q) When planning a group trip, you are the one who...
1) Worries most about travel plans and loding. You probably take the responsibility of planning if you can.
2) Let others worry about destinationss and logistics. You're along for a wild ride.
3) Follow the leader and cast your vote when needed. You're on the trip to relax, not stress.
4) Recommend some planning options. You're the backup leader.

*/

/* 
Q) 죽으면 바라는 것은?
1) 여러 세대에 걸쳐 가족을 부양할 수 있을 만큼 부유해지기를 바랍니다.
2) 성공을 거두고 세계를 여행했다.
3) 평생 친구들에게 둘러싸여 있다.
4) 알아야 할 모든 것을 배웠다.

Q) 한 무리의 불량배들이 범생이를 괴롭히는 것을 보았습니다. 당신은...
1) 불량배들에게 다가가서 소리를 지릅니다.
2) 나중에 범생이를 찾아서 그에게 다가갑니다.
3) 범생이에게 동정심을 느끼되 그냥 지나칩니다.
4) 조금 재미있다고 생각합니다.
...
Q) 좋아하는 사람에게 어떻게 바람을 피우나요?
1) 안 합니다. 마음에 들면 솔직하게 말합니다.
2) 진솔하고 깊은 대화를 시도합니다.
3) 재치 있는 농담을 하고 수줍은 미소를 지으며 상대의 마음을 사로잡습니다.
4) 상대방에게 멋지고 치기 어린 픽업이나 윙크를 합니다.

Q) 고등학교 때 가장 좋아했던 과외 활동은 무엇인가요?
1) 학생회.
2) 스포츠 팀.
3) 학생 클럽.
4) 토론 또는 학술 팀.

Q) 코너 상점에서 집에 돌아와서 계산이 조금 덜 된 것을 발견했습니다. 당신은...
1) 다시 가게로 돌아가서 차액을 지불합니다.
2) 몇 달러만 할인된 것이니 걱정하지 않습니다.
3) 다음에 쇼핑할 때 다시 가게 된다면 그 가게에 대해 이야기할 것입니다.
4) 운이 좋았습니다.

Q) 가치 있는 여름 휴가에 대한 귀하의 생각은 무엇입니까?
1) 고향에 있는 친구들과 어울려 놀기.
2) 아카풀코의 절벽에서 낙하산이나 다이빙.
3) 현관에서 좋은 책과 함께 컬링하기.
4) 여름 학교.

Q) 혼자만의 시간을 원할 때 어떻게 확보하나요?
1) 친구에게 사색 시간이라고 말하고 방으로 들어가요.
2) 친구들과의 영화 데이트에 취소합니다.
3) 세상과 단절된 채 오랜 시간 동안 사라집니다.
4) 심부름을 하거나 드라이브를 하세요.

Q) 단체 여행을 계획할 때, 당신은 ...
1) 여행 계획과 숙박에 대해 가장 걱정합니다. 가능하면 계획에 대한 책임을 지려고 합니다.
2) 다른 사람들이 목적지와 물류에 대해 걱정하도록 내버려 둡니다. 여러분은 모험을 떠나는 것이니까요.
3) 리더를 따르고 필요할 때 투표를 합니다. 여행은 스트레스를 풀러 가는 것이 아니라 휴식을 취하러 가는 것이니까요.
4) 몇 가지 계획 옵션을 추천합니다. 여러분은 백업 리더입니다.
